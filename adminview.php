...
<tr>
  <td style="padding: 10px;"><center><p><a class="button is-success" href="adminticketbooking.php?id=<?php echo $result['id'] ?>" name="submit" role="button">Book A Ticket &raquo;</a></p></center></td>
</tr>
