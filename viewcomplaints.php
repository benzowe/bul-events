...
<!-- 
  ...
  <center><h1 class="title">ENQUIRIES</h1></center>
  <aside class="menu">
    <p class="menu-label">
      VIEWS
    </p>
    ...
    <ul class="menu-list">
      <li>
        ...
        <ul>
          <li>
            ...
            <a href=""><i class="fas fa-spinner fa-spin"></i> Post Events</a>
      ...
      $result = $db->query("SELECT * FROM enquiries ");
      ?>
        <?php 
...
<tr>
  <td colspan="" rowspan="" headers="" style="padding: 40px;"><center> <img src="<?php echo $result ["banner"]?>" alt="" height="100" width="100"> </center></td>
    ...
    <tr>
      ...
      <th style="padding: 10px;" class="title"><center><?php  echo $result['MatricNumber'] ?></center></th>
    </tr>
  
<td style="padding: 10px;"><center><i class="fas fa-spinner fa-spin"></i><?php echo $result['enquiry'];?></center></td>
</tr>

<tr>
  <td style="padding: 10px;"><center><p><a class="button is-success" href="replyenquiry.php" name="submit" role="button">Reply Enquiry &raquo;</a></p></center></td>
</tr>
