...
<tr>
  <td style="padding: 10px;"><center><i class="fa fa-calendar">:</i><?php echo $ticket['date'] ?></center></td>
</tr>

<tr>
  <td style="padding: 10px;"><center><i class="fa fa-archive">:</i>Quantity <input type="text" name="quantity" id="quantity" size="5" style="border-radius: 10px; background-color: black; color: white;"></td>
</tr>

<tr>
  <td style="padding: 10px;"><center><p><a class="btn btn-success" href="receipts.php?id=<?php echo $ticket['id'] ?>" name="submit" role="button">Make Payment&raquo;</a></p></center></td>
</tr>
